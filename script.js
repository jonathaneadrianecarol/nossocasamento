    ...
    */
    ...
    if (heroVideo) {
        ...
        const timeline = [
            ...
            { start: 14, position: '20% center', zoom: 0.8},  // 5s: Zoom na ESQUERDA
            { start: 17, position: '80% center', zoom: 0.8 }, // 10s: Zoom na DIREITA
            { start: 25, position: '50% center', zoom: 1 }    // 15s: Volta ao Normal
        ];
